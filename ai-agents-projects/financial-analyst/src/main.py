...
try:
    with MCPServerAdapter(server_params) as mcp_tools:
        ...
        code_execution_agent = Agent(
            ...
            # tools=[mcp_tools["run_code_and_show_plot"]],
            tools=[mcp_tools["run_code_and_save_plot"]],
        ...
        result = crew.kickoff(inputs={"query": "Plot YTD stock gain of Alibaba and save it as stock-analysis.svg"})
